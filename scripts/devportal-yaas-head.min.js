...
!function(n){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=n();else if("function"==typeof define&&define.amd)define([],n);else{var e;e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,e.embedHashPersistencePlugin=n()}}(function(){return function n(e,o,i){function r(f,u){if(!o[f]){if(!e[f]){var c="function"==typeof require&&require;if(!u&&c)return c(f,!0);if(t)return t(f,!0);var s=new Error("Cannot find module '"+f+"'");throw s.code="MODULE_NOT_FOUND",s}var a=o[f]={exports:{}};e[f][0].call(a.exports,function(n){var o=e[f][1][n];return r(o?o:n)},a,a.exports,n,e,o,i)}return o[f].exports}for(var t="function"==typeof require&&require,f=0;f<i.length;f++)r(i[f]);return r}({1:[function(n,e,o){var i={url:"http://127.0.0.1:9778/build/"}.url;e.exports=function(n,e){e||(e=window),n.subscribe(function(o){var r=function(){var n=e.location.hash.substr(1),i=e.location.href;o.config("id",n),o.config("url",i)},t=function(){var n=o.options.config.id;n=null==n?"":String(n),e.location.hash.substr(1)!==n&&(e.location.hash=n,o.config("fullUrl",i+(n?"#"+n:"")))};r(),e.addEventListener("hashchange",r),o.on("config",function(n){if("id"===n)return t()}),n.unsubscribe(function(){e.removeEventListener("hashchange",r)})})}},{}]},{},[1])(1)});
